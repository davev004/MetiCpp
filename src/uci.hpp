    ...
    inline void loop() {
        ...
        while (std::getline(std::cin, line)) {
            ...
            if (token == "quit") {
                ...
                std::cout << "id name MetiC++" << std::endl;
                std::cout << "id author David Vaughan" << std::endl;

                std::cout << "option name Threads type spin default 1 min 1 max " << SMP::MAX_THREADS << std::endl;
